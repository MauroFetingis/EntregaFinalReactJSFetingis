...
const NoPage = () => {
  return (
    ...
    <img src="./img/busqueda.gif" alt="" /><p className="flex justify-center text-xl text-indigo-400 font-bold font-serif">Por favor pruebe más tarde</p> <a className=" text-4xl text-indigo-400 font-serif animate-bounce font-bold flex justify-center m-7 cursor-pointer" href="/home">Vovler al Inicio</a></div>
  )
}
